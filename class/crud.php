<?php
    ...
    class crud extends connection {
        ...
        public function insert($table, $col, $condition, $params) {
            $this->preparedStatements("insert into {$table} ({$col}) values ({$condition})", $params);
            return $this->crud;
        }

        public function selectAll($table, $col) {
            $this->preparedStatements("select {$col} from {$table}", array());
            return $this->crud;
        }

        public function selectById($table, $col, $condition, $params) {
            $this->preparedStatements("select {$col} from {$table} where {$condition}", $params);
            return $this->crud;
        }
        ...
        public function updateById($table, $col, $condition, $params) {
            $this->preparedStatements("update {$table} set {$col} where {$condition}", $params);
            return $this->crud;
        }
